...
<p align="center">
  ...
  <a href="https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.5-rc.1"><img src="https://img.shields.io/badge/dsh-%3E%3D0.1.5--rc.1-blue" alt="最低 dsh 版本" style="max-width:100%;"></a>
...
- Node.js ≥ 22.19（或 ≥ 24）
- 宿主 dsh 0.1.5-rc.1（`@deepseek-ai/dsh-*` peer 依赖均为 `^0.1.5-rc.1`，兼容范围另见 `engines.dsh`；上游发布稳定版之前只跟最新预发布线，不向后兼容）
