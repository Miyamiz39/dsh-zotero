...
- Node.js ≥ 22.19 or ≥ 24
- DSH 0.1.5-rc.2 (peer dependencies listed in package.json; only the latest pre-release line is supported until upstream stabilizes, with no backward compatibility)
