...
const FIELD_SPECS = [
  ...
  { key: 'docxMaxBytes', kind: 'number', group: 'groupOutput' },
  { key: 'defaultStyle', kind: 'text', group: 'groupDefaults' },
  { key: 'defaultLocale', kind: 'text', group: 'groupDefaults' },
  { key: 'researchEnabled', kind: 'boolean', group: 'groupDefaults' },
  { key: 'docxEnabled', kind: 'boolean', group: 'groupDefaults' },
  { key: 'docxLegacyMarkers', kind: 'boolean', group: 'groupDefaults' },
